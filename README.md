...
```
 sed -i -e 's|rsyslog-8.2102.0-106.el9|rsyslog|g' /home/awx21/tools/ansible/roles/dockerfile/templates/Dockerfile.j2
```
...
```
19. vim /home/awx21/tools/docker-compose/_sources/docker-compose.yml
